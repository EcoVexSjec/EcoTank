...
export default function Register() {
  ...
  const [role, setRole] = useState('member'); // 'leader' or 'member'
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-900 relative overflow-hidden py-12">
      ...
      <div className="z-10 w-full max-w-md bg-slate-800/50 backdrop-blur-xl p-8 rounded-2xl border border-slate-700/50 shadow-2xl">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 mt-2 text-sm">Register your account for the ideathon</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            disabled={loading}
            className="w-full bg-gradient-to-r from-emerald-400 to-cyan-400 hover:from-emerald-300 hover:to-cyan-300 text-slate-950 font-extrabold py-3 px-4 rounded-lg transition-all shadow-[0_0_20px_rgba(16,185,129,0.3)] mt-4"
            type="submit"
          >
